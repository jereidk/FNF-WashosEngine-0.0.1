...
class ASTCTexture {
    ...
    static function getASTCFormat(blockWidth:Int, blockHeight:Int):Int {
        return switch [blockWidth, blockHeight] {
            case [4, 4]: GL.COMPRESSED_RGBA_ASTC_4x4_KHR;
            case [5, 4]: GL.COMPRESSED_RGBA_ASTC_5x4_KHR;
            case [5, 5]: GL.COMPRESSED_RGBA_ASTC_5x5_KHR;
            case [6, 5]: GL.COMPRESSED_RGBA_ASTC_6x5_KHR;
            case [6, 6]: GL.COMPRESSED_RGBA_ASTC_6x6_KHR;
            case [8, 5]: GL.COMPRESSED_RGBA_ASTC_8x5_KHR;
            case [8, 6]: GL.COMPRESSED_RGBA_ASTC_8x6_KHR;
            case [8, 8]: GL.COMPRESSED_RGBA_ASTC_8x8_KHR;
            case [10, 5]: GL.COMPRESSED_RGBA_ASTC_10x5_KHR;
            case [10, 6]: GL.COMPRESSED_RGBA_ASTC_10x6_KHR;
            case [10, 8]: GL.COMPRESSED_RGBA_ASTC_10x8_KHR;
            case [10, 10]: GL.COMPRESSED_RGBA_ASTC_10x10_KHR;
            case [12, 10]: GL.COMPRESSED_RGBA_ASTC_12x10_KHR;
            case [12, 12]: GL.COMPRESSED_RGBA_ASTC_12x12_KHR;
